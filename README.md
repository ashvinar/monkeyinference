...
`apply_mixed_five_trit`, `ternary_trit_qmm`, `ternary_qmm_m8`, PLD, early-exit, and DFlash stay in the tree. They are the evidence. Production `load_text_model` does not enable five-trit. Production `generate` does not speculate.
